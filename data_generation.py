# file for generating ground truth data of ROBER and POLLU systems
...
def get_data():
    ...
    # print(sol_rober.nfev, 'evaluations required for ROBER.')
    ...
    # print(sol_pollu.nfev, 'evaluations required for POLLU.')
...
def save_data():
    ...
    p = {'sp1': sol_pollu.y[0], 'sp2': sol_pollu.y[1], 'sp3': sol_pollu.y[2], 'sp4': sol_pollu.y[3],
         'sp5': sol_pollu.y[4],
         'sp6': sol_pollu.y[5], 'sp7': sol_pollu.y[6], 'sp8': sol_pollu.y[7], 'sp9': sol_pollu.y[8],
         'sp10': sol_pollu.y[9],
